class Bank {
  ...
  def transfer(firstacc: Account, secondacc: Account, amount: Int) = {
    ...
    else "Current balance is not sufficient to transfer such amount"
  }
}
...
case class Account(balance: Int, accnr: Int) {
  ...
  def withdraw(amount: Int) = {
    ...
    else "Current balance is not sufficient to withdraw such amount"
  }
...
object Main extends App {
  ...
  val operationWithd = account2.withdraw(300)
